...
/* Some programs will use italics in favor of reverse video. If the host
 * terminal doesn't support italics, this will fail.
 * Define REVERSE_ITALICS to map italic text to reverse text.
 */
...
#define MOVE_UP         KEY('k')
#define MOVE_DOWN       KEY('j')
#define MOVE_RIGHT      KEY('l')
#define MOVE_LEFT       KEY('h')
#define MOVE_OTHER      KEY(L'o')

/* The split terminal keys. */
#define HSPLIT KEY(L'\r')
#define VSPLIT KEY(L' ')
